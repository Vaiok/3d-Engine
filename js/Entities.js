...
function buildEntity(posX, posY, posZ, posSpdX, posSpdY, posSpdZ, rotX, rotY, rotZ) {
	...
	partsArr.sat[0].sat[0] = makeBlockData('joint', {x: 0, y: 0, z: 0}, {x: 0, y: BU*1, z: 0},
									{x: 0, y: 0, z: 0, spd: {x: 0, y: 0, z: 0}, min: {x: 0, y: -Math.PI/3, z: 0}, max: {x: 0, y: Math.PI/3, z: 0}},
									{r: 1, g: 0.6, b: 0.6});// Neck Joint1
	partsArr.sat[0].sat[0].sat[0] = makeBlockData('joint', {x: 0, y: 0, z: 0}, {x: 0, y: 0, z: 0},
									{x: 0, y: 0, z: 0, spd: {x: 0, y: 0, z: 0}, min: {x: -Math.PI*2/13, y: 0, z: -Math.PI/5}, max: {x: Math.PI*2/13, y: 0, z: Math.PI/5}},
...
function createObjectMatrices(partsArr) {
	...
	partsArr.quat = q4.eulerToQuat(partsArr.data.rot.x, partsArr.data.rot.y, partsArr.data.rot.z);
	partsArr.mat = m4.mult(partsArr.mat, q4.quatToRotMat(partsArr.quat));
